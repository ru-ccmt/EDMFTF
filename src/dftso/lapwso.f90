...
2030 format(///)
  ...
  DO ik=1,1000000
     ...
     call cputim(dtime0)
     ! Sets up Hamiltonian in band basis, and returns the new eigenvector vect(K,iband_is,up/dn)
     ! where iband_is is the band index in enlarged Hilber space, up/dn is projection to up and dn spin.
