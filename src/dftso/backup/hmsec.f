           ...
           do  ity=1,nat
              ...
              do  l=1,1
                 ...
                 do mi=-l,l                 
                    ...
                    do ina=0,mult(ity)-1    
                       indj=lfirst+ina
                       ovrlc = ovrlc + abcdlm(1,ilmi,indj,iei,isd)*dconjg(abcdlm(1,ilmi,indj,ief,isu)) &
                            +   abcdlm(2,ilmi,indj,iei,isd)*dconjg(abcdlm(2,ilmi,indj,ief,isu))*pei(l+1,ity,isu) &
                            +   abcdlm(1,ilmi,indj,iei,isd)*dconjg(abcdlm(3,ilmi,indj,ief,isu))*ru2u(l,ity,isu,isd) &
                            +   abcdlm(3,ilmi,indj,iei,isd)*dconjg(abcdlm(1,ilmi,indj,ief,isu))*ru2u(l,ity,isu,isd) &
                            +   abcdlm(2,ilmi,indj,iei,isd)*dconjg(abcdlm(3,ilmi,indj,ief,isu))*ru2ud(l,ity,isu,isd)&
                            +   abcdlm(3,ilmi,indj,iei,isd)*dconjg(abcdlm(2,ilmi,indj,ief,isu))*ru2ud(l,ity,isu,isd)&
                            +   abcdlm(3,ilmi,indj,iei,isd)*dconjg(abcdlm(3,ilmi,indj,ief,isu))  &
                            +   abcdlm(1,ilmi,indj,iei,isd)*dconjg(abcdlm(4,ilmi,indj,ief,isu))*rup(l,ity,isu,isd) &
                            +   abcdlm(4,ilmi,indj,iei,isd)*dconjg(abcdlm(1,ilmi,indj,ief,isu))*rup(l,ity,isu,isd) &
                            +   abcdlm(2,ilmi,indj,iei,isd)*dconjg(abcdlm(4,ilmi,indj,ief,isu))*rudp(l,ity,isu,isd)&
                            +   abcdlm(4,ilmi,indj,iei,isd)*dconjg(abcdlm(2,ilmi,indj,ief,isu))*rudp(l,ity,isu,isd)&
                            +   abcdlm(4,ilmi,indj,iei,isd)*dconjg(abcdlm(3,ilmi,indj,ief,isu))*ru2p(l,ity,isu,isd)&
                            +   abcdlm(3,ilmi,indj,iei,isd)*dconjg(abcdlm(4,ilmi,indj,ief,isu))*ru2p(l,ity,isu,isd)&
                            +   abcdlm(4,ilmi,indj,iei,isd)*dconjg(abcdlm(4,ilmi,indj,ief,isu))*rrr (l,ity,isu,isd)
                    enddo
                 enddo
              enddo
           enddo
              ...
              do ity=1,nat           ! 600
                 ...
                 do l=1,1            ! 600
                    ...
                    do ina=0,mult(ity)-1
                       ...
                       do m1=-l,l   ! 620
                          ilmi = l*l +l + m1 +1
                          hsoc = hsoc + abcdlm(1,ilmi,indj,iei,isd)*dconjg(abcdlm(1,ilmi,indj,ief,isu))*hexl(l,ity,isu,1) &
                                      + abcdlm(1,ilmi,indj,iei,isd)*dconjg(abcdlm(2,ilmi,indj,ief,isu))*hexl(l,ity,isu,2) &
                                      + abcdlm(1,ilmi,indj,iei,isd)*dconjg(abcdlm(4,ilmi,indj,ief,isu))*hexl(l,ity,isu,3) &
                                      + abcdlm(2,ilmi,indj,iei,isd)*dconjg(abcdlm(4,ilmi,indj,ief,isu))*hexl(l,ity,isu,6) &
                                      + abcdlm(4,ilmi,indj,iei,isd)*dconjg(abcdlm(1,ilmi,indj,ief,isu))*hexl(l,ity,isu,7) &
                                      + abcdlm(4,ilmi,indj,iei,isd)*dconjg(abcdlm(2,ilmi,indj,ief,isu))*hexl(l,ity,isu,8) &
                                      + abcdlm(4,ilmi,indj,iei,isd)*dconjg(abcdlm(4,ilmi,indj,ief,isu))*hexl(l,ity,isu,9)
                       enddo
                       if (lvns(ity)) then
