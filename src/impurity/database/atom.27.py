n=[5,6,7,8,9]     # Atomic valences
l=2               # Orbital angular momentum of the shel
J=1.00            # Slater integrals F2=J*11.9219653179191 from the atomic physics program (took from Hansmann, Andersen, Held paper on Nickelate heterstructures -Chuck)
