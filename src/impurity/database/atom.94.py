n=[4,5,6,7] # Atomic valences for oca
nc=[4,5,6,7] # Atomic valences for ctqmc
l=3         # Orbital angular momentum of the shel
J=0.512     # Slatter integrals F2=J*11.9219653179191 from the atomic physics program
cx=0.22     # spin-orbit coupling from the atomic physics program
