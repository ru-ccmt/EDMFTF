n=[5,6,7,8] # Atomic valences for oca
nc=[5,6,7,8] # Atomic valences for ctqmc
l=3         # Orbital angular momentum of the shel
J=0.625     # Slatter integrals F2=J*11.9219653179191 from the atomic physics program
cx=0.252    # spin-orbit coupling from the atomic physics program
