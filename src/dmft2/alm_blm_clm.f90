...
!!! BRISI
    !if (jatom.eq.2) then
    !   write(1999,'(3I3,1x)',advance='no') latom, is
    !   write(1999,*) 'alm'
    !   do j=1,lmax2lmax2
    !      write(1999,'(10x)',advance='no') 
    !      do i=1,nbands_dft
    !         write(1999,'(2f20.15,1x)',advance='no') alm(j,i+nemin-1)
    !      enddo
    !      write(1999,*)
    !   enddo
    !   write(1999,*) 'blm'
    ...
    !      write(1999,'(10x)',advance='no') 
    !      do i=1,nbands_dft
    !         write(1999,'(2f20.15,1x)',advance='no') blm(j,i+nemin-1)
    !      enddo
    !      write(1999,*)
    !   enddo
    !   write(1999,*) 'clm'
    !   do j=1,lomaxlomax
    !      do l=0,10
    !         if (l**2 .lt. j .and. j.le.(l+1)**2) exit
    !      enddo
    !      do jlo=1,ilo(l)
    !         write(1999,'(I3,I3,4x)',advance='no') l, jlo
    !         do i=1,nbands_dft
    !            write(1999,'(2f20.15,1x)',advance='no') clm(j,i+nemin-1,jlo)
    !         enddo
    !         write(1999,*)
    !      enddo
    !   enddo
    ...
    !         write(1999,'(10x)',advance='no') 
    !         do i=1,nbands_dft
    !            write(1999,'(2f20.15,1x)',advance='no') aalm(j,i,ik)
    !         enddo
    !         write(1999,*)
    !      enddo
    !      !write(1999,*)
    ...
    !         write(1999,'(10x)',advance='no') 
    !         do i=1,nbands_dft
    !            write(1999,'(2f20.15,1x)',advance='no') bblm(j,i,ik)
    !         enddo
    !         write(1999,*)
    !      enddo
    !      !write(1999,*)
    ...
    !            write(1999,'(I3,I3,4x)',advance='no') l, jlo
    !            do i=1,nbands_dft
    !               write(1999,'(2f20.15,1x)',advance='no') cclm(j,i,jlo,ik)
    !            enddo
    !            write(1999,*)
    !         enddo
    !         !if (ilo(l).gt.0) write(1999,*)
    !      enddo
    !      !write(1999,*)
    !   enddo
    !   write(1999,*)
